  ...
  useGesture(
    {
      onDragStart: ({ event }) => {
        ...
        if (pointerTypeRef.current === 'touch') pointerEvent.preventDefault()
        ...
        const potential = (pointerEvent.target as HTMLElement | null)?.closest?.('.item__image')
        tapTargetRef.current = potential instanceof HTMLElement ? potential : null
      },
          ...
          <div className="stage">
            <div ref={sphereRef} className="sphere">
              {items.map((it, i) => (
                ...
                >
                  <div
                    className="item__image absolute block cursor-pointer overflow-hidden bg-black transition-transform duration-300"
                    role="button"
                    tabIndex={0}
