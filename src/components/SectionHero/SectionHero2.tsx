...
const data = [
  {
    ...
    para: 'CupCake Desires bakes small-batch, hand-frosted cupcakes every morning. Premium ingredients, indulgent flavours, and perfect gift boxes for every celebration.',
    btnText: 'Sweet Squad ',
  ...
  },
  {
    ...
    heading: 'Celebrate Every Moment With CupCake Desires.',
    subHeading: 'Made in Melbourne. Small-batch. Eggless & Vegan options available.',
    para: 'CupCake Desires bakes small-batch, hand-frosted cupcakes every morning. Premium ingredients, indulgent flavours, and perfect gift boxes for every celebration.',
    btnText: 'Sweet Squad',
    btnHref: '/collections/all-items',
