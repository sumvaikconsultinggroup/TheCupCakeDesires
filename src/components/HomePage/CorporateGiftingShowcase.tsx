...
export default function CorporateGiftingShowcase() {
  ...
  return (
    <section className="relative overflow-hidden bg-ivory text-cocoa">
      ...
      <div className="relative mx-auto grid max-w-[1320px] items-start gap-8 px-6 pb-28 pt-14 md:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] md:gap-4 md:px-10 md:pb-36 md:pt-20 lg:gap-10">
