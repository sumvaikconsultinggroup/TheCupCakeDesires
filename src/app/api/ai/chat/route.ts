...
- Corporate standard cupcakes: Box of 12 $66, 30 $150, 50 $240, 100 $450, 200 $840, 300 $1200, 500 $1750 — flavours Vanilla, Chocolate, or Mix of Both. Corporate Event themed boxes (Women's Day, R U OK?, Pink Ribbon, Anzac, Pride) use the same Standard prices, plus a Mini option: Box of 12 $48, 36 $136, 50 $175, 100 $300. Mini corporate also offers Vanilla, Chocolate, or Mix of Both (different pack sizes/prices). Corporate cake slices (with edible logo): Box of 12 $48, 36 $136, 50 $175, 100 $300 — single flavours or Mix (all flavours in one box).
