  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-2xl font-bold text-neutral-900 dark:text-white">Shipping</h1>
          <p className="text-neutral-500">Manage shipments and delivery through Shiprocket</p>
        </div>
      </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        updateSetting('pickupAddress.pincode', value)
                      }}
                      placeholder="400001"
                      maxLength={6}
                      className="w-full rounded-xl border border-neutral-200 px-4 py-2.5 outline-none focus:border-[#1B198F] dark:border-neutral-700 dark:bg-neutral-900"
