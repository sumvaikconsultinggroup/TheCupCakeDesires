/** Content sourced from https://thecupcakedesire.com.au/best-cupcake-shops-in-melbourne-cbd/ */

export const BEST_CUPCAKE_SHOPS_CBD_SLUG = 'best-cupcake-shops-in-melbourne-cbd'

export const BEST_CUPCAKE_SHOPS_CBD_POST = {
  title: 'Best Cupcake Shops in Melbourne CBD',
  slug: BEST_CUPCAKE_SHOPS_CBD_SLUG,
  excerpt:
