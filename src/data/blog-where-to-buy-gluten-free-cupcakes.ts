/** Content sourced from https://thecupcakedesire.com.au/where-to-buy-gluten-free-cupcakes/ */

export const WHERE_TO_BUY_GF_SLUG = 'where-to-buy-gluten-free-cupcakes'

export const WHERE_TO_BUY_GF_POST = {
  title: 'Where to Buy Gluten-Free Cupcakes',
  slug: WHERE_TO_BUY_GF_SLUG,
  excerpt:
